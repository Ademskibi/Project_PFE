...
const Navbar = () => {
  ...
  return (
    <nav className="flex justify-end items-center px-6 py-4 bg-white border-b shadow-md relative">
      <div className="flex items-center gap-8">
        ...
        <div className="flex gap-6">
          <button
            ...
            className="p-2 flex items-center gap-1 rounded hover:bg-indigo-700 transition"
            title="Orders"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
      ...
      <div className="relative" ref={dropdownRef}>
        <button
          ...
          className="p-2 rounded hover:bg-indigo-700 transition relative"
          title="Notifications"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
